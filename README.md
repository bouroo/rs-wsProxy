...
A tiny, fast Rust bridge that lets WebSocket clients talk to plain TCP servers. It was built for [roBrowserLegacy](https://github.com/MrAntares/roBrowserLegacy) and the [RagnarokRebuildTcp](https://github.com/Doddler/RagnarokRebuildTcp/tree/master/RebuildClient) client, but works with any TCP backend.
