...
A tiny, fast Rust bridge that lets WebSocket clients talk to plain TCP servers. It was built for [roBrowser](https://github.com/vthibault/roBrowser) and the [RagnarokRebuildTcp](https://github.com/Doddler/RagnarokRebuildTcp) client, but works with any TCP backend.
